...
public class Utilities {
    ...
    public static final String CREAR_TABLA_EVENTOS = "CREATE TABLE " + TABLA_EVENTS + "("+ CAMPO_IMG + " INTEGER, " + CAMPO_EVENT + " TEXT, " + CAMPO_TYPE + " TEXT, "+ CAMPO_DATE + " DATE, "
    + CAMPO_TIME + " DATE, " + CAMPO_CONTACT + " TEXT, " + CAMPO_VALUE + " DOUBLE)";
